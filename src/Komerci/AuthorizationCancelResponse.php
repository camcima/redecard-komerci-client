...
class AuthorizationCancelResponse
{
    ...
    /**
     * Is Authorization Canceled?
     * 
     * @return boolean Is Authorization Canceled?
     */
    ...
    /**
     * Set Authorization Cancel Result XML
     * 
     * @param string $xmlResult Authorization Cancel Result XML
     */
